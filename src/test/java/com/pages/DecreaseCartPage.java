...
public class DecreaseCartPage {
	...
	public void DecreaseCart() {
		...
		driver.findElement(By.xpath("//input[@inputmode='numeric']")).sendKeys(Keys.ARROW_DOWN);
	}
	//To update the decreased cart
	public void clcikUpadte() {
		driver.findElement(By.xpath("//input[@value='Update Basket']")).click();
	}
	//To check whether the cart is decreased or not
	public void AssertDecrease() {
	...
	//To take the screenshot after decreased cart
	public void Screenshot() throws Exception {
		TakesScreenshot ts= (TakesScreenshot)driver;
		File source=ts.getScreenshotAs(OutputType.FILE);
		FileUtils.copyFile(source,new File("src\\test\\resources\\Screenshots\\DecreasedCart.png"));
	}
}
