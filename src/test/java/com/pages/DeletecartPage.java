...
public class DeletecartPage {
	...
	//To click the delete in cart
	public void deletecart() {
		driver.findElement(By.xpath("//a[@title='Remove this item']")).click();
	}
	//To check whether deletion is done or not
	public void AssertDelete() {
		String c = driver.findElement(By.xpath("//p[@class='cart-empty']")).getText();
		Assert.assertEquals("Your basket is currently empty.",c);
		System.out.println("Deleted Successfully");
	}
	//To take screenshot  after deletion
	public void Screenshot() throws Exception {
		TakesScreenshot ts= (TakesScreenshot)driver;
		File source=ts.getScreenshotAs(OutputType.FILE);
		FileUtils.copyFile(source,new File("src\\test\\resources\\Screenshots\\DeletedCart.png"));
	}
}
